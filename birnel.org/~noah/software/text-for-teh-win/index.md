...
<div id="main">
<p>Edit any text panel using your favourite text editor under Windows.</p>
<p><a href="./text-for-teh-win.zip">Here</a> is the installer.  Download it, unzip it, open the folder, and double click install.exe.  </p>
<p>The <a href="https://github.com/nbirnel/text-for-teh-win.git">source</a> is on github.</p>
</div>
<div id="footer">
