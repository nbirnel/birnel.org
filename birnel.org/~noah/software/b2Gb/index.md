...
<div id="main">
<p>b2Gb, a little utility to convert bytes to gigibytes in the Windows clipboard.</p>
<p>To use, copy a byte quantity (which may have commas), then double-click 
b2Gb.exe. You can then paste the gigibyte quantity.</p>
<p>Source is available at <a href="http://www.github.com/nbirnel/b2Gb.git">github</a></p>

<p><a href="./b2Gb.zip">Download</a></p>
<h2>License</h2>
